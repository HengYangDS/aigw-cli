...
func TestRunSeparatesMeasurementAndVerdictFailures(t *testing.T) {
	...
	for _, testCase := range []struct {
		...
		{"measurement", verificationResult{}, errors.New("probe failed"), "probe failed"},
		{"verdict", func() verificationResult {
...
func TestRunReportsPresentationFailures(t *testing.T) {
	...
	writeReport = func(io.Writer, verificationResult, bool) error {
...
func sampleVerification() verificationResult {
	resolved := modelProbe{Model: "gpt-5.6-sol", Present: true, MetadataSHA256: "134063e133f0b4244fa3b251acf973d4fe4b4aeeacbdc135211bf480f59f1477"}
	fallback := modelProbe{Model: "openai.gpt-5.6-sol"}
	adapted := resolved
