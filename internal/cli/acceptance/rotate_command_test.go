...
func TestRotateReportsProjectionRollbackFailure(t *testing.T) {
	...
	addAccountProfile(&cfg, "one", "one", "One", configuration.Endpoints{OpenAIResponses: "https://one.test/v1"}, configuration.ClientCodex, configuration.Models{configuration.ClientCodex: "gpt-test"})
...
func TestRotateClaudeOnlyAccountDoesNotTouchCodexTargets(t *testing.T) {
	...
	cfg.Profiles["gpt"] = configuration.Profile{Label: "GPT", Account: "codex-account", Client: configuration.ClientCodex, Models: configuration.Models{configuration.ClientCodex: "gpt-test"}}
	cfg.Profiles["claude"] = configuration.Profile{Label: "Claude", Account: "claude-account", Client: configuration.ClientClaude, Models: configuration.Models{configuration.ClientClaude: "claude-test"}}
