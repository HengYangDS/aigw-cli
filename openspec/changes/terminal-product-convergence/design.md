...
| ----- | --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1     | 5.4, 12.8, 12.6, 13.6             | Close native Codex table-edit ownership before delivery, then complete packaged and hosted configuration-aware rollback acceptance. Current source and three-platform packaged rollback journeys pass. Historical dispatch HTTP 500 blocks only that qualification; advance independent closures without claiming current historical or final published-byte acceptance. Preserve operator state. |
