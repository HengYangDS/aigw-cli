...
- [x] 1.1 Advance `VERSION` to `0.1.0-rc.106` and verify
      `go run ./tools/release validate-release-sources` passes.
- [x] 1.2 Move the accepted progressive-onboarding continuation from
      `[Unreleased]` into the dated `0.1.0-rc.106` section and verify changelog
      chronology.
