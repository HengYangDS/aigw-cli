...
Each behavior and policy SHALL have one semantic owner, with composition roots
limited to assembly. Source gates MUST reject compatibility shims, forwarding
wrappers, alias-only packages, forbidden product references, unmanaged flat
structure, and any package or aggregate statement coverage that is not strictly
