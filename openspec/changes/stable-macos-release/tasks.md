...
- [ ] 4.1 Update canonical release policy and installation documentation, removing superseded RC-only and notarization-out-of-scope statements.
- [ ] 4.2 Run focused tests, source gates, exact-HEAD proof, and required native CI against frozen inputs.
- [ ] 4.3 Publish one signed stable tag and identical accepted assets to both selected peers; verify hosted checks and downloads.
