...
- [x] 8.3 Document complete setup, deferred synchronization, credential, installation, update, rollback, uninstall, Provider extension, Client extension, and optional-gateway journeys; verify every referenced source and artifact is tracked or publicly reachable.
