...
required = [
    ...
    "go test -race ./...", "go vet ./...", "scripts/check-product-surface.sh", "scripts/check-governance.sh", "scripts/check-credential-fixtures.sh", "scripts/test-credential-fixtures.sh",
