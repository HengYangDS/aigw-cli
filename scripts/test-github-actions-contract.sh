...
required = [
    ...
    "actions/setup-go@0c52d547c9bc32b1aa3301fd7a9cb496313a4491", 'go-version: "1.25.8"', "check-latest: false", "GOTOOLCHAIN: go1.25.8", "scripts/check-release-toolchain.sh",
