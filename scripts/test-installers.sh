...
for forbidden in curl wget gh glab GITHUB_TOKEN GITLAB_TOKEN AIGW_GITLAB_RELEASE_HOST AIGW_GITLAB_RELEASE_PROJECT AIGW_GITHUB_RELEASE_HOST AIGW_GITHUB_RELEASE_PROJECT; do
