...
gitlab_allowed_signers=${AIGW_GITLAB_ALLOWED_SIGNERS:-$root/packaging/release/gitlab-allowed-signers}
github_allowed_signers=${AIGW_GITHUB_ALLOWED_SIGNERS:-$root/packaging/release/github-allowed-signers}
github_legacy_allowed_signers=${AIGW_GITHUB_LEGACY_ALLOWED_SIGNERS:-$root/packaging/release/github-legacy-allowed-signers}
github_legacy_tags=${AIGW_GITHUB_LEGACY_TAGS:-$root/packaging/release/github-legacy-tags.txt}
