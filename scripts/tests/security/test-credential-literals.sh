...
checker="$root/scripts/checks/security/check-credential-literals.sh"
...
mkdir -p "$copy/scripts/checks/security"
cp "$checker" "$copy/scripts/checks/security/check-credential-literals.sh"
(
  cd "$copy"
