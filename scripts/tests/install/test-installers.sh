...
unix_script="$root/scripts/install/install.sh"
powershell_script="$root/scripts/install/install.ps1"
...
for forbidden in curl wget gh glab GITHUB_TOKEN GITLAB_TOKEN AIGW_GITLAB_RELEASE_ORIGIN AIGW_GITLAB_RELEASE_REPOSITORY AIGW_GITHUB_RELEASE_ORIGIN AIGW_GITHUB_RELEASE_REPOSITORY; do
