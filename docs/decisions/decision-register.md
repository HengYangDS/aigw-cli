...
and inbound links belong to the successor; the retired sequence stays unused.
Tool-mandated names such as `go.mod`, `spec.md`, and
...
| [DR-0004](dr-0004-account-profile-client-binding-authority.md) | Use Account, Profile, and Client Binding as the configuration authority. |
...
| [DR-0011](dr-0011-single-portable-token-backend.md)            | Select one portable Account Token backend per installation.              |
